...
DHDCFLAGS += -DCONFIG_BCM43756=$(CONFIG_BCM43756)
...
DHDCFLAGS += -DARP_IPV6NSRS_PKTPRIO_OVERRIDE
DHDCFLAGS += -DPKTPRIO_OVERRIDE
DHDCFLAGS += -DNDO_CONFIG_SUPPORT
DHDCFLAGS += -DDISABLE_TXACK_ALIVE
...
DHDCFLAGS += -DRSSI_MONITOR_SUPPORT
#RTT
DHDCFLAGS += -DRTT_SUPPORT -DRTT_DEBUG -DWL_RTT_CTS -DWL_RTT_ONE_WAY
#NDOffload
DHDCFLAGS += -DNDO_CONFIG_SUPPORT
...
# For 4389, 43752 and 43756
ifneq ($(filter y, $(CONFIG_BCM4389) $(CONFIG_BCM43752) $(CONFIG_BCM43756) $(CONFIG_BCM4375) $(CONFIG_BCM4385)),)
  DHDCFLAGS += -DUSE_WL_TXBF
...
ifneq ($(filter y, $(CONFIG_BCM43756)),)
        DHDCFLAGS += -DBCMPCI_DEV_ID=0x449d
        DHDCFLAGS += -DBCMPCI_NOOTP_DEV_ID=0x4362
endif
ifneq ($(filter y, $(CONFIG_BCM4389)),)
